...
<table class='wp-list-table widefat fixed'>
    ...
    echo "<td class='" . $row_bgcolor[$row_bgcolor_index] . "'>" . $row->Engine . "</td>";
    echo "<td class='" . $row_bgcolor[$row_bgcolor_index] . "' nowrap><a href='" . $this->url['list'] . '&#038table_name=' . $tName . "'>$tName</a></td>";
        echo "<td class='" . $row_bgcolor[$row_bgcolor_index] . "'>" . $row->Rows . "</td>";
        echo "<td class='" . $row_bgcolor[$row_bgcolor_index] . "'>" . $row->Create_time . "</td>";
        echo "<td class='" . $row_bgcolor[$row_bgcolor_index] . "'>" . $row->Update_time . "</td>";
