...
Tags: mysql, crud, table, database, simple, export, query, phpMyAdmin, sql, database manager, mariadb
...
ZacWP PhpMyAdmin enables database management, custom query and exporting them to CSV files through minimal database interface from your wp-admin page menu.
